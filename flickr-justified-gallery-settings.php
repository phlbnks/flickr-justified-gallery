...
if (!function_exists( 'fjgwpp_plugin_uninstall')) {
	function fjgwpp_plugin_uninstall() {
		...
		if (get_option('$fjgwpp_APISecret')) {
			delete_option('$fjgwpp_APISecret');
		}
		if (get_option('$fjgwpp_APIToken')) {
			delete_option('$fjgwpp_APIToken');
		}
...
?>
	...
	<div class="wrap">
		...
		<div id="poststuff">
				...
				<div class="inside">
					...
					<form method="post" name="options" target="_self">
						...
						<table class="form-table">
							...
							<tr>
								<th scope="row">
									<label><?php _e('Flickr API Secret', 'fjgwpp'); ?></label>
								</th>
								<td>
									<label for="fjgwpp_APISecret">
									<input type="text" name="fjgwpp_APISecret"
										value="<?php echo($fjgwpp_APISecret_saved); ?>"
										style="margin-right:10px"
									/>
									<div><?php _e('You can\'t use an attribute to change this setting', 'fjgwpp'); ?></div>
									</label>
							...
							<tr>
								<th scope="row">
									<label><?php _e('Flickr API Token', 'fjgwpp'); ?></label>
								</th>
								<td>
									<label for="fjgwpp_APIToken">
									<input type="text" name="fjgwpp_APIToken"
										value="<?php echo($fjgwpp_APIToken_saved); ?>"
										style="margin-right:10px"
									/>
									<div><?php _e('You can\'t use an attribute to change this setting', 'fjgwpp'); ?></div>
									</label>
							...
							<tr>
								...
								<td>
									<label for="fjgwpp_userID">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'user_id' . __('</code> attribute to change this default value', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<label for="">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'last_row' . __('</code> attribute to change this default value (with the value <code>justify</code>, <code>nojustify</code> or <code>hide</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<label for="fjgwpp_fixedHeight">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'fixed_height' . __('</code> attribute to change this default value (with the value <code>true</code> or <code>false</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<label for="fjgwpp_pagination">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'pagination' . __('</code> attribute to change this default value (with the value <code>none</code>, <code>prevnext</code> or <code>numbers</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'lightbox' . __('</code> attribute to change this default value (with the value <code>none</code>, <code>colorbox</code> or <code>swipebox</code>).', 'fjgwpp') ); ?></div>
									</label>
									<br/>
							...
							<tr>
								...
								<td>
									...
									<?php _e('If enabled, the title of the photo will be shown over the image when the mouse is over. Note: <i>captions, with small images, become aesthetically unpleasing</i>.', 'fjgwpp'); ?></li>
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'captions' . __('</code> attribute to change this default value (with the value <code>true</code> or <code>false</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<label for="fjgwpp_randomize">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'randomize' . __('</code> attribute to change this default value (with the value <code>true</code> or <code>false</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<label for="fjgwpp_openOriginals">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'open_originals' . __('</code> attribute to change this default value (with the value <code>true</code> or <code>false</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<label for="fjgwpp_bcontextmenu">
										...
										<div><?php echo( __('You can use the <code>', 'fjgwpp') . 'block_contextmenu' . __('</code> attribute to change this default value (with the value <code>true</code> or <code>false</code>)', 'fjgwpp') ); ?></div>
									</label>
								</td>
							</tr>
							<tr>
			...
			<div class="postbox">
				<h3><?php _e('Help the project', 'fjgwpp' ); ?></h3>
				<div class="inside">
					<p>
